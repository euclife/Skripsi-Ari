		...
		<div class="card-body flex-wrap border-0 pt-6 pb-0">
			<form class="form" id="form">
				...
				<div class="form-group row">
					...
					<div class="col-lg-9 col-md-9 col-sm-12">
						<textarea type="text" id="tentang_field" class="form-control" name="tentang" placeholder="Masukkan tentang kontrak"></textarea>
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-lg-9 col-md-9 col-sm-12">
						<input type="text" id="nomor_field" class="form-control" name="nomor" placeholder="Masukkan nomor kontrak"/>
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-lg-9 col-md-9 col-sm-12">
						<input type="text" id="tanggal_surat_pesanan_field" class="form-control" readonly name="tanggal_surat_pesanan"
							   placeholder="Pilih Tanggal"/>
					</div>
				</div>

				<div class="form-group row">
					<label class="col-form-label text-right col-lg-3 col-sm-12">File Dokumen Surat Perjanjian/Kontrak *</label>
					<div class="col-lg-9 col-md-9 col-sm-12">
						<input type="file" id="file_dokumen_surat_perjanjian" class="form-control" name="file_dokumen_perjanjian">
					</div>
				</div>
			...
			<form class="form" id="formBarang">
				<div class="form-group row">
					<div class="col-lg-3">
						...
						<input type="number" class="form-control" name="barang[]nama_barang" placeholder="" value=""/>
					</div>
					<div class="col-lg-2">
						<label>Jumlah Barang : </label>
						<input type="number" class="form-control" id="jumlah_barang" name="barang[]jumlah_barang"/>
					</div>
					<div class="col-lg-2">
						<label>Satuan:</label>
						<input type="text" class="form-control" id="satuan" placeholder="ex : kg, cm, pcs, dll" name="barang[]satuan"/>
					</div>
					<div class="col-lg-2">
						<label>Harga Satuan:</label>
						<input type="number" class="form-control" name="barang[]harga_satuan"/>
					</div>
					<div class="col-lg-2">
						<label>Total Harga:</label>
						<input type="text" class="form-control" readonly id="satuan" name="barang[]total_harga"/>
					</div>
					<div class="col-lg-1">
						<label></label>
						<button type="button" class="btn btn-danger mt-2 btnHapusBarang" onclick="hapusBarang(this)" data-id="0" >Hapus</button>
					</div>
				</div>
			</form>
			<div class="form-group row">
				<div class="col-lg-12 ml-lg-auto mb-3 mx-auto">
					<button type="button" id="btnTambahBarang" class="btn btn-primary font-weight-bold mr-2">Tambah Barang</button>
				</div>
			</div>
		</div>
	</div>
							...
							<div class="col-lg-6 row">
								<div class="col-lg-12">
									<div class="form-group row">
										...
										<div class="col-lg-9 col-md-9 col-sm-12">
											<select type="text" class="form-control select2" name="provinsi" id="modal_provinsi_field"></select>
											<span></span>
										</div>
									</div>
								</div>
								<div class="col-lg-12">
									<div class="form-group row">
										...
										<div class="col-lg-9 col-md-9 col-sm-12">
											<select type="text" class="form-control select2" id="modal_kota_field" name="kota"></select>
											<span></span>
										</div>
									</div>
								</div>
								<div class="col-lg-12">
									<div class="form-group row">
										...
										<div class="col-lg-9 col-md-9 col-sm-12">
											<select name="kode_pos" type="text" class="form-control select2" id="modal_kode_pos_field"></select>
											<span></span>
										</div>
									</div>
								</div>
...
@section("scripts")
	<script type="text/javascript">
		...
		$(document).ready(function () {
			...
			let tanggalSerahTerimaBarang = $("#tanggal_serah_terima_barang_field");
			...
			const fvPerusahaan = FormValidation.formValidation(
				formPerusahaanValidation,
				{
					fields: {
						nama: {
							validators: {
			...
			function setErrorPerusahaan(data){
				if (typeof data.nama !== 'undefined') {
					$.each( data.nama, function( key, value ) {
						namaPerusahaanField.next(".fv-plugins-message-container").append(`
						 <div data-field="name" data-validator="notEmpty" class="fv-help-block">${value}</div>`);
					});
				}

				if (typeof data.alamat !== 'undefined') {
					$.each( data.alamat, function( key, value ) {
						alamatPerusahaanField.next(".fv-plugins-message-container").append(`
						 <div data-field="name" data-validator="notEmpty" class="fv-help-block">${value}</div>`);
					});
				}

				if (typeof data.nomor_telepon !== 'undefined') {
					$.each( data.nomor_telepon, function( key, value ) {
						nomorTeleponField.next(".fv-plugins-message-container").append(`
						 <div data-field="name" data-validator="notEmpty" class="fv-help-block">${value}</div>`);
					});
				}

				if (typeof data.nomor_fax !== 'undefined') {
					$.each( data.nomor_fax, function( key, value ) {
						nomorFaxField.next(".fv-plugins-message-container").append(`
						 <div data-field="name" data-validator="notEmpty" class="fv-help-block">${value}</div>`);
					});
				}

				if (typeof data.website !== 'undefined') {
					$.each( data.website, function( key, value ) {
						websiteField.next(".fv-plugins-message-container").append(`
						 <div data-field="name" data-validator="notEmpty" class="fv-help-block">${value}</div>`);
					});
				}

				if (typeof data.provinsi !== 'undefined') {
					$.each( data.provinsi, function( key, value ) {
						provinsiField.next(".fv-plugins-message-container").append(`
						 <div data-field="name" data-validator="notEmpty" class="fv-help-block">${value}</div>`);
					});
				}

				if (typeof data.kota !== 'undefined') {
					$.each( data.kota, function( key, value ) {
						kotaField.next(".fv-plugins-message-container").append(`
						 <div data-field="name" data-validator="notEmpty" class="fv-help-block">${value}</div>`);
					});
				}

				if (typeof data.kode_pos !== 'undefined') {
					$.each( data.kode_pos, function( key, value ) {
						kodePosField.next(".fv-plugins-message-container").append(`
						 <div data-field="name" data-validator="notEmpty" class="fv-help-block">${value}</div>`);
					});
				}
