    ...
    <div class="card card-custom col-12">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label">Table Barang
                    <div class="text-muted pt-2 font-size-sm">Table data barang</div>
                </h3>
            </div>
            <div class="card-toolbar">
                ...
                <!--end::Dropdown-->
                <!--begin::Button-->
                <a href="{{route("Barang.create")}}" class="btn btn-primary font-weight-bolder">
                <span class="svg-icon svg-icon-md">
        ...
        <div class="card-body col-12">
            <table class="table table-bordered table-hover" id="kt_datatable">
                ...
                <tr>
                    ...
                    <th>Harga Satuan</th>
                    <th>Total</th>
                    <th>Di pesan oleh perusahaan</th>
                    <th>Tanggal di buat</th>
                    <th>Tanggal terakhir di rubah</th>
                    <th>Nama pembuat</th>
                    <th>Terakhir di rubah oleh</th>
                    <th>Nota</th>
                </tr>
                </thead>
                <tbody>
    ...
    <script type="text/javascript">
        $.extend($.fn.dataTable.defaults, {
            language: {
                ...
                sZeroRecords: "Tidak ditemukan data barang yang sesuai",
                sEmptyTable: "Tidak ada data barang yang tersedia pada tabel ini",
